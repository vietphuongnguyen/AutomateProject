Feature: Active account by sms
  ...
  Scenario: Input excel file content info to create account then change status of account to Waiting for user and active by sms syntax airtime
    ...
    When user send sms with systax: "ECC nt 10" to 8099
